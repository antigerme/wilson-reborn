...
| 2d | Polir: som, persistência do dia, arte recriada melhor, empacotamento `.scr` | 🟡 **em curso** — ✅ **som** (`rodio`/`audio`) · ✅ **persistência do dia** (`state.rs`, arco de 11 dias entre sessões); próximo: arte recriada melhor |
