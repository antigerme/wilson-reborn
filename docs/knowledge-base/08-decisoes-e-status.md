...
| 2d | Polir: som, persistência do dia, arte recriada melhor, empacotamento `.scr` | 🟡 **em curso** — ✅ **som** (`rodio`, feature `audio`, `soundN.wav` via `--data`); próximo: persistência do dia |
