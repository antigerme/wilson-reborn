...
> leitura profunda de **todos** os arquivos de `repos/` (jc_reborn, dgds/ScummVM, JCOS,
...
- `repos/`: `jc_reborn` (jno6809), `Johnny-Castaway-Open-Source`/JCOS (nivs1978),
  `castaway` & `dgds-viewer` (xesf), `dgds` (ScummVM/vcosta).
